menu = require("menu")
utils  = require("utils")
filter = require("filters." .. utils.get_character_class())
dump = require("dump")
            ...
            if filter_table then
                ...
                if #item_affixes > 1 then
                    ...
                    for _, affix in pairs(item_affixes) do
                        if affix then                              
                            for _, filter_entry in pairs(filter_table) do
                                -- console.print(dump(affix.affix_name_hash));   
...
console.print("Lua Plugin - Affix Filter");
console.print("Affix Filter: Detected class: " .. utils.get_character_class());
